...
const randomPhraseMaker = () =>{
    ...
    let startingNumber = Math.floor(Math.random()* startingPhrases.length) ;
    let itemNumber = Math.floor(Math.random() * itemsNeeded.length);
    let reasonNumber = Math.floor(Math.random()* reasonToNeedThatItem.length);

    console.log(startingNumber);
    console.log(itemNumber);
    console.log(reasonNumber);
    console.log(startingPhrases[startingNumber] + itemsNeeded[itemNumber] + reasonToNeedThatItem[reasonNumber]); 
}
